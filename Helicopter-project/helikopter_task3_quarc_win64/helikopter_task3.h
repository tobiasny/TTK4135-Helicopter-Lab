 ...
 */
#ifndef RTW_HEADER_helikopter_task3_h_
#define RTW_HEADER_helikopter_task3_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef helikopter_task3_COMMON_INCLUDES_
# define helikopter_task3_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* helikopter_task3_COMMON_INCLUDES_ */

#include "helikopter_task3_types.h"
...
#define helikopter_task3_rtModel       RT_MODEL_helikopter_task3_T
...
#define rtB                            helikopter_task3_B
#define BlockIO                        B_helikopter_task3_T
#define rtX                            helikopter_task3_X
#define ContinuousStates               X_helikopter_task3_T
#define rtXdot                         helikopter_task3_XDot
#define StateDerivatives               XDot_helikopter_task3_T
#define tXdis                          helikopter_task3_XDis
#define StateDisabled                  XDis_helikopter_task3_T
#define rtP                            helikopter_task3_P
#define Parameters                     P_helikopter_task3_T
#define rtDWork                        helikopter_task3_DW
#define D_Work                         DW_helikopter_task3_T

/* Parameters (auto storage) */
struct P_helikopter_task3_T_ {
...
struct tag_RTM_helikopter_task3_T {
  const char_T *path;
...
extern P_helikopter_task3_T helikopter_task3_P;

/* Block signals (auto storage) */
extern B_helikopter_task3_T helikopter_task3_B;

/* Continuous states (auto storage) */
extern X_helikopter_task3_T helikopter_task3_X;

/* Block states (auto storage) */
extern DW_helikopter_task3_T helikopter_task3_DW;

/* Model entry point functions */
extern void helikopter_task3_initialize(void);
extern void helikopter_task3_output(void);
extern void helikopter_task3_update(void);
extern void helikopter_task3_terminate(void);

/* Real-time Model object */
extern RT_MODEL_helikopter_task3_T *const helikopter_task3_M;
 ...
 *
 * '<Root>' : 'helikopter_task3'
 * '<S1>'   : 'helikopter_task3/Conversion'
 * '<S2>'   : 'helikopter_task3/Degrees to Radians'
 * '<S3>'   : 'helikopter_task3/Degrees to Radians1'
 * '<S4>'   : 'helikopter_task3/Degrees to Radians2'
 * '<S5>'   : 'helikopter_task3/Elevation controller'
 * '<S6>'   : 'helikopter_task3/Helicopter_interface'
 * '<S7>'   : 'helikopter_task3/Pitch controller'
 * '<S8>'   : 'helikopter_task3/Helicopter_interface/Elevation rad to deg'
 * '<S9>'   : 'helikopter_task3/Helicopter_interface/Elevation rate rad to deg'
 * '<S10>'  : 'helikopter_task3/Helicopter_interface/Pitch rad to deg'
 * '<S11>'  : 'helikopter_task3/Helicopter_interface/Pitch rate rad to deg'
 * '<S12>'  : 'helikopter_task3/Helicopter_interface/Pitch rate rad to deg1'
 * '<S13>'  : 'helikopter_task3/Helicopter_interface/Travel rad to deg'
 * '<S14>'  : 'helikopter_task3/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helikopter_task3_h_ */

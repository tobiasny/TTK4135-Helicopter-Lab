/*
 * helikopter_task4_without_feed.h
 *
 ...
 */
#ifndef RTW_HEADER_helikopter_task4_without_feed_h_
#define RTW_HEADER_helikopter_task4_without_feed_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef helikopter_task4_without_feed_COMMON_INCLUDES_
# define helikopter_task4_without_feed_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* helikopter_task4_without_feed_COMMON_INCLUDES_ */

#include "helikopter_task4_without_feed_types.h"
...
#define helikopter_task4_without_feed_rtModel RT_MODEL_helikopter_task4_wit_T

/* Block signals (auto storage) */
typedef struct {
  real_T FromWorkspace6;               /* '<Root>/From Workspace6' */
...
} B_helikopter_task4_without_fe_T;
...
} DW_helikopter_task4_without_f_T;
...
} X_helikopter_task4_without_fe_T;
...
} XDis_helikopter_task4_without_T;
...
#define rtB                            helikopter_task4_without_feed_B
#define BlockIO                        B_helikopter_task4_without_fe_T
#define rtX                            helikopter_task4_without_feed_X
#define ContinuousStates               X_helikopter_task4_without_fe_T
#define rtXdot                         helikopter_task4_without_f_XDot
#define StateDerivatives               XDot_helikopter_task4_without_T
#define tXdis                          helikopter_task4_without_f_XDis
#define StateDisabled                  XDis_helikopter_task4_without_T
#define rtP                            helikopter_task4_without_feed_P
#define Parameters                     P_helikopter_task4_without_fe_T
#define rtDWork                        helikopter_task4_without_fee_DW
#define D_Work                         DW_helikopter_task4_without_f_T

/* Parameters (auto storage) */
struct P_helikopter_task4_without_fe_T_ {
  ...
  boolean_T HILInitialize_set_analog_outp_c;/* Mask Parameter: HILInitialize_set_analog_outp_c
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_analog_out_ct;/* Mask Parameter: HILInitialize_set_analog_out_ct
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  ...
  boolean_T HILInitialize_set_digital_out_a;/* Mask Parameter: HILInitialize_set_digital_out_a
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_digital_ou_aj;/* Mask Parameter: HILInitialize_set_digital_ou_aj
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_encoder_count;/* Mask Parameter: HILInitialize_set_encoder_count
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_encoder_cou_p;/* Mask Parameter: HILInitialize_set_encoder_cou_p
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  ...
  boolean_T HILInitialize_set_pwm_params_at;/* Mask Parameter: HILInitialize_set_pwm_params_at
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_pwm_params__p;/* Mask Parameter: HILInitialize_set_pwm_params__p
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
...
struct tag_RTM_helikopter_task4_with_T {
  const char_T *path;
...
extern P_helikopter_task4_without_fe_T helikopter_task4_without_feed_P;

/* Block signals (auto storage) */
extern B_helikopter_task4_without_fe_T helikopter_task4_without_feed_B;

/* Continuous states (auto storage) */
extern X_helikopter_task4_without_fe_T helikopter_task4_without_feed_X;

/* Block states (auto storage) */
extern DW_helikopter_task4_without_f_T helikopter_task4_without_fee_DW;

/* Model entry point functions */
extern void helikopter_task4_without_feed_initialize(void);
extern void helikopter_task4_without_feed_output(void);
extern void helikopter_task4_without_feed_update(void);
extern void helikopter_task4_without_feed_terminate(void);

/* Real-time Model object */
extern RT_MODEL_helikopter_task4_wit_T *const helikopter_task4_without_fee_M;
 ...
 *
 * '<Root>' : 'helikopter_task4_without_feed'
 * '<S1>'   : 'helikopter_task4_without_feed/Conversion'
 * '<S2>'   : 'helikopter_task4_without_feed/Degrees to Radians'
 * '<S3>'   : 'helikopter_task4_without_feed/Degrees to Radians1'
 * '<S4>'   : 'helikopter_task4_without_feed/Degrees to Radians2'
 * '<S5>'   : 'helikopter_task4_without_feed/Elevation controller'
 * '<S6>'   : 'helikopter_task4_without_feed/Helicopter_interface'
 * '<S7>'   : 'helikopter_task4_without_feed/Pitch controller'
 * '<S8>'   : 'helikopter_task4_without_feed/Helicopter_interface/Elevation rad to deg'
 * '<S9>'   : 'helikopter_task4_without_feed/Helicopter_interface/Elevation rate rad to deg'
 * '<S10>'  : 'helikopter_task4_without_feed/Helicopter_interface/Pitch rad to deg'
 * '<S11>'  : 'helikopter_task4_without_feed/Helicopter_interface/Pitch rate rad to deg'
 * '<S12>'  : 'helikopter_task4_without_feed/Helicopter_interface/Pitch rate rad to deg1'
 * '<S13>'  : 'helikopter_task4_without_feed/Helicopter_interface/Travel rad to deg'
 * '<S14>'  : 'helikopter_task4_without_feed/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helikopter_task4_without_feed_h_ */

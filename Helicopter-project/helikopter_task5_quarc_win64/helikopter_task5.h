 ...
 */
#ifndef RTW_HEADER_helikopter_task5_h_
#define RTW_HEADER_helikopter_task5_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef helikopter_task5_COMMON_INCLUDES_
# define helikopter_task5_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* helikopter_task5_COMMON_INCLUDES_ */

#include "helikopter_task5_types.h"
...
#define helikopter_task5_rtModel       RT_MODEL_helikopter_task5_T
...
#define rtB                            helikopter_task5_B
#define BlockIO                        B_helikopter_task5_T
#define rtX                            helikopter_task5_X
#define ContinuousStates               X_helikopter_task5_T
#define rtXdot                         helikopter_task5_XDot
#define StateDerivatives               XDot_helikopter_task5_T
#define tXdis                          helikopter_task5_XDis
#define StateDisabled                  XDis_helikopter_task5_T
#define rtP                            helikopter_task5_P
#define Parameters                     P_helikopter_task5_T
#define rtDWork                        helikopter_task5_DW
#define D_Work                         DW_helikopter_task5_T

/* Parameters (auto storage) */
struct P_helikopter_task5_T_ {
...
struct tag_RTM_helikopter_task5_T {
  const char_T *path;
...
extern P_helikopter_task5_T helikopter_task5_P;

/* Block signals (auto storage) */
extern B_helikopter_task5_T helikopter_task5_B;

/* Continuous states (auto storage) */
extern X_helikopter_task5_T helikopter_task5_X;

/* Block states (auto storage) */
extern DW_helikopter_task5_T helikopter_task5_DW;

/* Model entry point functions */
extern void helikopter_task5_initialize(void);
extern void helikopter_task5_output(void);
extern void helikopter_task5_update(void);
extern void helikopter_task5_terminate(void);

/* Real-time Model object */
extern RT_MODEL_helikopter_task5_T *const helikopter_task5_M;
 ...
 *
 * '<Root>' : 'helikopter_task5'
 * '<S1>'   : 'helikopter_task5/Conversion'
 * '<S2>'   : 'helikopter_task5/Degrees to Radians'
 * '<S3>'   : 'helikopter_task5/Degrees to Radians1'
 * '<S4>'   : 'helikopter_task5/Degrees to Radians2'
 * '<S5>'   : 'helikopter_task5/Elevation controller'
 * '<S6>'   : 'helikopter_task5/Helicopter_interface'
 * '<S7>'   : 'helikopter_task5/Pitch controller'
 * '<S8>'   : 'helikopter_task5/Helicopter_interface/Elevation rad to deg'
 * '<S9>'   : 'helikopter_task5/Helicopter_interface/Elevation rate rad to deg'
 * '<S10>'  : 'helikopter_task5/Helicopter_interface/Pitch rad to deg'
 * '<S11>'  : 'helikopter_task5/Helicopter_interface/Pitch rate rad to deg'
 * '<S12>'  : 'helikopter_task5/Helicopter_interface/Pitch rate rad to deg1'
 * '<S13>'  : 'helikopter_task5/Helicopter_interface/Travel rad to deg'
 * '<S14>'  : 'helikopter_task5/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helikopter_task5_h_ */

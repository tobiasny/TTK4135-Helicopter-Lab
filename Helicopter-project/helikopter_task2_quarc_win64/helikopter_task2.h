 ...
 */
#ifndef RTW_HEADER_helikopter_task2_h_
#define RTW_HEADER_helikopter_task2_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef helikopter_task2_COMMON_INCLUDES_
# define helikopter_task2_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* helikopter_task2_COMMON_INCLUDES_ */

#include "helikopter_task2_types.h"
...
#define helikopter_task2_rtModel       RT_MODEL_helikopter_task2_T
...
#define rtB                            helikopter_task2_B
#define BlockIO                        B_helikopter_task2_T
#define rtX                            helikopter_task2_X
#define ContinuousStates               X_helikopter_task2_T
#define rtXdot                         helikopter_task2_XDot
#define StateDerivatives               XDot_helikopter_task2_T
#define tXdis                          helikopter_task2_XDis
#define StateDisabled                  XDis_helikopter_task2_T
#define rtP                            helikopter_task2_P
#define Parameters                     P_helikopter_task2_T
#define rtDWork                        helikopter_task2_DW
#define D_Work                         DW_helikopter_task2_T

/* Parameters (auto storage) */
struct P_helikopter_task2_T_ {
  ...
  boolean_T HILInitialize_set_pwm_params__f;/* Mask Parameter: HILInitialize_set_pwm_params__f
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  real_T Traveloffset_Value;           /* Expression: 180
                                        * Referenced by: '<Root>/Travel offset'
                                        */
...
struct tag_RTM_helikopter_task2_T {
  const char_T *path;
...
extern P_helikopter_task2_T helikopter_task2_P;

/* Block signals (auto storage) */
extern B_helikopter_task2_T helikopter_task2_B;

/* Continuous states (auto storage) */
extern X_helikopter_task2_T helikopter_task2_X;

/* Block states (auto storage) */
extern DW_helikopter_task2_T helikopter_task2_DW;

/* Model entry point functions */
extern void helikopter_task2_initialize(void);
extern void helikopter_task2_output(void);
extern void helikopter_task2_update(void);
extern void helikopter_task2_terminate(void);

/* Real-time Model object */
extern RT_MODEL_helikopter_task2_T *const helikopter_task2_M;
 ...
 *
 * '<Root>' : 'helikopter_task2'
 * '<S1>'   : 'helikopter_task2/Conversion'
 * '<S2>'   : 'helikopter_task2/Degrees to Radians'
 * '<S3>'   : 'helikopter_task2/Degrees to Radians1'
 * '<S4>'   : 'helikopter_task2/Degrees to Radians2'
 * '<S5>'   : 'helikopter_task2/Elevation controller'
 * '<S6>'   : 'helikopter_task2/Helicopter_interface'
 * '<S7>'   : 'helikopter_task2/Pitch controller'
 * '<S8>'   : 'helikopter_task2/Helicopter_interface/Elevation rad to deg'
 * '<S9>'   : 'helikopter_task2/Helicopter_interface/Elevation rate rad to deg'
 * '<S10>'  : 'helikopter_task2/Helicopter_interface/Pitch rad to deg'
 * '<S11>'  : 'helikopter_task2/Helicopter_interface/Pitch rate rad to deg'
 * '<S12>'  : 'helikopter_task2/Helicopter_interface/Pitch rate rad to deg1'
 * '<S13>'  : 'helikopter_task2/Helicopter_interface/Travel rad to deg'
 * '<S14>'  : 'helikopter_task2/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helikopter_task2_h_ */

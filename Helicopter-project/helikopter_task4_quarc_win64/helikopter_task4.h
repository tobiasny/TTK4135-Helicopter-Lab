 ...
 */
#ifndef RTW_HEADER_helikopter_task4_h_
#define RTW_HEADER_helikopter_task4_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef helikopter_task4_COMMON_INCLUDES_
# define helikopter_task4_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* helikopter_task4_COMMON_INCLUDES_ */

#include "helikopter_task4_types.h"
...
#define helikopter_task4_rtModel       RT_MODEL_helikopter_task4_T
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } PtichrateScopedegs1_PWORK;         /* '<S9>/Ptich rate: Scope [deg//s]1' */
  ...
  struct {
    void *LoggedData;
  } Backmotor_PWORK;                   /* '<S9>/Back motor' */

  struct {
    void *LoggedData;
  } Frontmotor_PWORK;                  /* '<S9>/Front motor' */
...
#define rtB                            helikopter_task4_B
#define BlockIO                        B_helikopter_task4_T
#define rtX                            helikopter_task4_X
#define ContinuousStates               X_helikopter_task4_T
#define rtXdot                         helikopter_task4_XDot
#define StateDerivatives               XDot_helikopter_task4_T
#define tXdis                          helikopter_task4_XDis
#define StateDisabled                  XDis_helikopter_task4_T
#define rtP                            helikopter_task4_P
#define Parameters                     P_helikopter_task4_T
#define rtDWork                        helikopter_task4_DW
#define D_Work                         DW_helikopter_task4_T

/* Parameters (auto storage) */
struct P_helikopter_task4_T_ {
  ...
  real_T K_pd;                         /* Variable: K_pd
                                        * Referenced by: '<S10>/K_pd'
                                        */
  real_T K_pp;                         /* Variable: K_pp
                                        * Referenced by: '<S10>/K_pp'
                                        */
...
struct tag_RTM_helikopter_task4_T {
  const char_T *path;
...
extern P_helikopter_task4_T helikopter_task4_P;

/* Block signals (auto storage) */
extern B_helikopter_task4_T helikopter_task4_B;

/* Continuous states (auto storage) */
extern X_helikopter_task4_T helikopter_task4_X;

/* Block states (auto storage) */
extern DW_helikopter_task4_T helikopter_task4_DW;

/* Model entry point functions */
extern void helikopter_task4_initialize(void);
extern void helikopter_task4_output(void);
extern void helikopter_task4_update(void);
extern void helikopter_task4_terminate(void);

/* Real-time Model object */
extern RT_MODEL_helikopter_task4_T *const helikopter_task4_M;
 ...
 *
 * '<Root>' : 'helikopter_task4'
 * '<S1>'   : 'helikopter_task4/Conversion'
 * '<S2>'   : 'helikopter_task4/Degrees to Radians'
 * '<S3>'   : 'helikopter_task4/Degrees to Radians1'
 * '<S4>'   : 'helikopter_task4/Degrees to Radians2'
 * '<S5>'   : 'helikopter_task4/Degrees to Radians3'
 * '<S6>'   : 'helikopter_task4/Degrees to Radians4'
 * '<S7>'   : 'helikopter_task4/Degrees to Radians5'
 * '<S8>'   : 'helikopter_task4/Elevation controller'
 * '<S9>'   : 'helikopter_task4/Helicopter_interface'
 * '<S10>'  : 'helikopter_task4/Pitch controller'
 * '<S11>'  : 'helikopter_task4/Helicopter_interface/Elevation rad to deg'
 * '<S12>'  : 'helikopter_task4/Helicopter_interface/Elevation rate rad to deg'
 * '<S13>'  : 'helikopter_task4/Helicopter_interface/Pitch rad to deg'
 * '<S14>'  : 'helikopter_task4/Helicopter_interface/Pitch rate rad to deg'
 * '<S15>'  : 'helikopter_task4/Helicopter_interface/Pitch rate rad to deg1'
 * '<S16>'  : 'helikopter_task4/Helicopter_interface/Travel rad to deg'
 * '<S17>'  : 'helikopter_task4/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helikopter_task4_h_ */

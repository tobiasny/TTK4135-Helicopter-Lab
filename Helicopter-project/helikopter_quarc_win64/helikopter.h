 ...
 * '<S3>'   : 'helikopter/Degrees to Radians1'
 * '<S4>'   : 'helikopter/Elevation controller'
 * '<S5>'   : 'helikopter/Helicopter_interface'
 * '<S6>'   : 'helikopter/Pitch controller'
 * '<S7>'   : 'helikopter/Helicopter_interface/Elevation rad to deg'
 * '<S8>'   : 'helikopter/Helicopter_interface/Elevation rate rad to deg'
 * '<S9>'   : 'helikopter/Helicopter_interface/Pitch rad to deg'
 * '<S10>'  : 'helikopter/Helicopter_interface/Pitch rate rad to deg'
 * '<S11>'  : 'helikopter/Helicopter_interface/Pitch rate rad to deg1'
 * '<S12>'  : 'helikopter/Helicopter_interface/Travel rad to deg'
 * '<S13>'  : 'helikopter/Helicopter_interface/Travel rate  rad to deg'
 */
